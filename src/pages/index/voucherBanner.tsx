      ...
      <div className=" relative bg-white p-4 rounded-md shadow-md flex flex-col z-20" >
        <div className=" flex items-center justify-between">
          <div className=" flex items-center space-x-4">
            <img className=" h-[40px] aspect-square rounded-full " src="https://pub-d79d527fdb044f488b110e2a9ab47e06.r2.dev/Logo.jpg.png" alt="" />
            <span className=" font-bold text-base text-slate-700 ">Minh Nguyen</span>
          </div>
