      ...
      <Swiper slidesPerView={2.2} spaceBetween={8} className="px-4">
        {productsCategory.map((category) => (
          <SwiperSlide key={category.lable}>
            <div onClick={() => {gotoCategory(category.categoryId)}} className=" relative pb-2 flex flex-col items-center bg-white border-b-2 border-r border-slate-300  rounded-lg  p-1 ">
              <div
                className="flex flex-col items-center relative w-full aspect-[2/3] rounded-lg bg-cover bg-center bg-skeleton"
